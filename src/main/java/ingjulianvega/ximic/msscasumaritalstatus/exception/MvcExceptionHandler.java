...
import ingjulianvega.ximic.msscasumaritalstatus.configuration.MaritalStatusParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(MaritalStatusParameters maritalStatusParameters) {
        this.maritalStatusParameters = maritalStatusParameters;
    }

    MaritalStatusParameters maritalStatusParameters;


    @ExceptionHandler(MaritalStatusException.class)
    public ResponseEntity<ApiError> validationErrorHandler(MaritalStatusException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(maritalStatusParameters.getApi())
